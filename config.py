...
DEFAULTS = {
    ...
    "token_shop_text": '<tg-emoji emoji-id="5312361253610475399">🛍</tg-emoji> <b>Магазин ресурсов</b>\n\nЗдесь можно тратить токены на ресурсы, редкие позиции, донат и наборы.\nВыберите категорию ниже.',
    "rules_text": "Правила пока не заданы.",
    "maintenance_text": "<b>Технический перерыв</b>\n\nБот временно недоступен. Попробуйте позже.",
    ...
    "ref_arrow_left_icon": "id:5258236805890710909",
    "ref_arrow_right_icon": "id:5260450573768990626",
    "tasks_done_icon": "✅",
    "tasks_not_done_icon": "❌",
    "tasks_received_icon": "✅",
    "tasks_open_icon": "➕",
    ...
    "btn_emoji_rules": "📜",
    "btn_emoji_promo": "🎁",
    "btn_icon:nav:token_shop": "id:5312361253610475399",
    "daily_actions_reset_time": "00:00",
}
